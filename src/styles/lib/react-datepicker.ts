...
.react-datepicker-popper--header-middle[data-placement^='bottom']
  .react-datepicker__triangle,
.react-datepicker-popper--header-bottom[data-placement^='bottom']
  .react-datepicker__triangle {
  fill: #fff;
  color: #fff;
}
.react-datepicker-popper--header-bottom[data-placement^='top']
  .react-datepicker__triangle {
  fill: #0dbc3d;
  color: #0dbc3d;
}
...
.react-datepicker__month-year-read-view {
  ...
  border-radius: 0.3rem;
  position: relative;
  /* v9: these are now <button> elements — reset native button styles */
