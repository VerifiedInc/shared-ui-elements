...
import { OneClickVerificationConversionChart } from '../../../components/chart';

const meta = {
  title: 'components/chart/OneClickVerificationConversionChart',
  component: OneClickVerificationConversionChart,
  parameters: {
    layout: 'centered',
  },
  decorators: [
  ...
  tags: ['autodocs'],
} satisfies Meta<typeof OneClickVerificationConversionChart>;
